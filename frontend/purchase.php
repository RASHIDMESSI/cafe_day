    ...
    if(isset($_POST['purchase']))
    {
        ...
        if(mysqli_query($conn,$query1))
        {
            ...
            if($stmt)
            {
                ...
                ?>
                <form action="thankyou.php" class="inputs" method="POST" name="form1" id="form1">
                ...
                <input type="hidden" name="cus_add2" value="karnataka">
                <input type="hidden" name="cus_city" value="<?php echo $cus_city; ?>">
                <input type="hidden" name="cus_state" value="Karnataka">
                <input type="hidden" name="cus_postcode" value="1206">
                <input type="hidden" name="cus_country" value="india">
